                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card p-2 shadow">
                            <div class="d-flex align-items-center px-2">
                                <i class="fa fa-info-circle float-start fa-3x py-auto" aria-hidden="true"></i>
                            ...
                            <div class="card-footer bg-white">
                                <small class="text-start fw-bold">Your Informasi</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card p-2 shadow">
                            <div class="d-flex align-items-center px-2">
                                <i class="fa fa-id-card fa-3x py-auto" aria-hidden="true"></i>
                                <div class="card-body text-end">
                            ...
                            <div class="card-footer bg-white">
                                <small class="text-start fw-bold">Your Participant</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card p-2 shadow">
                            ...
                            <div class="card-footer bg-white">
                                <small class="text-start fw-bold">Your Pasien</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card p-2 shadow">
                            ...
                            <div class="card-footer bg-white">
                                <small class="text-start fw-bold">Your User</small>
                            </div>
                        </div>
                    </div>
                </div>
